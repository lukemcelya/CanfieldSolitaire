...
{
	size_t mdSize = mainDeck.getDeckSize();
...
void handlePlayerMove(deck &mainDeck, deck &stock, reserve &reservePile, foundation *foundationPile[], tableau *tableauPile[])
{
	...
	case 4:
		...
		validateTableauMove(moveSelection, cardSelection, tableauPile, *pileMap[pileSelection]);
...
void validateTableauMove(int moveSelection, int cardSelection, tableau *tableauPile[], pile &pileToValidate)
{
